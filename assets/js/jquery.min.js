          ...
          return g !== n && 9 === g.nodeType && g.documentElement
            ? ((n = g),
              ...
              (c.qsa = $.test(g.querySelectorAll)) &&
                (jb(function (a) {
                  (o.appendChild(a).innerHTML = "<a id='" + u + "'></a><select required id='" + u + "-\f]' msallowcapture=''><option selected=''></option></select>"),
          ...
          preFilter: {
            ...
            CHILD: function (a) {
              return (
                (a[1] = a[1].toLowerCase()),
                "nth" === a[1].slice(0, 3)
                  ? (a[3] || gb.error(a[0]), (a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * ("even" === a[3] || "odd" === a[3]))), (a[5] = +(a[7] + a[8] || "odd" === a[3])))
                  : a[3] && gb.error(a[0]),
                a
              );
            },
