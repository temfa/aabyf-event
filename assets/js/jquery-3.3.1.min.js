          ...
          return a !== p && 9 === a.nodeType && a.documentElement
            ? ((p = a),
              ...
              (n.qsa = G.test(p.querySelectorAll)) &&
                (se(function (e) {
                  (h.appendChild(e).innerHTML = "<a id='" + x + "'></a><select required id='" + x + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                ...
                se(function (e) {
                  e.innerHTML = "<a href='' disabled='disabled'></a><select required disabled='disabled'><option/></select>";
