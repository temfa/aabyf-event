          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-lg-auto">
             ...
             <!-- <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="https://www.allafricabaptistyouthfellowship.com/testimonials.html">Testimonials</a>
              </li>
              <li class="nav-item">
          ...
          <div class="row footer-top-29">
            ...
            <div class="footer-logo"><img src="../assets/images/logo.png" alt="Your logo" title="Your logo" /></div>
              <p class="sub-list-text mt-4 pt-lg-2">
                Founded in 1984, the All Africa Baptist Youth Fellowship (AABYF) is a department under the All Africa Baptist Fellowship (AABF); which is an arm of the Baptist World Alliance.
              </p>
            </div>
