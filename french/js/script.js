        ...
        <img src="../assets/images/logo.png" alt="Your logo" title="Your logo" style="height:85px;" />
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-lg-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="https://aabyf-website.netlify.app/testimonials.html">Témoignages</a>
              </li>
              <li class="nav-item">
             ...
             <!--  <li class="dropdown">
                <a type="button" class="nav-link dropdown-toggle" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Ressources</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="nav-link" href="blog.html">Blog</a>
                  <a href="gallery.html" class="nav-link">Galerie</a>
                  <a href="presentations.html" class="nav-link">Présentations</a>
                  <a href="reports.html" class="nav-link">Rapports</a>
                  <a href="publications.html" class="nav-link">Ouvrages</a>
                </div>
              </li>
               <li class="dropdown">
                <a type="button" class="nav-link dropdown-toggle" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Délégués</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="nav-link" href="blog.html">Assister à</a>
                  <a href="accomodations.html" class="nav-link">Hébergement</a>
                  <a href="faq.html" class="nav-link">Faq</a>
                  <a href="contact.html" class="nav-link">Contact</a>
                </div>
              </li>
              <li class="nav-button">
                <a class="btn login-btn" role="button" href="login.html">Connexion</a>
              </li> -->
              <li class="dropdown">
                <a type="button" class="nav-link dropdown-toggle" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Enregistrer</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="nav-link" href="blog.html">Délégués ghanéens</a>
                  <a href="register.html" class="nav-link">Délégués internationaux</a>
                </div>
              </li>
              <!-- search button -->
              ...
              <!-- //search button -->
              <li class="dropdown">
              <a type="button" class="nav-link dropdown-toggle" id="navbarDropdown2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Fre</a>
          ...
          <div class="row footer-top-29">
            ...
            <div class="footer-logo"><img src="../assets/images/logo.png" alt="Your logo" title="Your logo" /></div>
              <p class="sub-list-text mt-4 pt-lg-2">
                Fondée en 1984, la All Africa Baptist Youth Fellowship est un département de la All Africa Baptist Fellowship à part entière en tant qu'organisme régional de l'Alliance baptiste mondiale.
              </p>
            </div>
            ...
            <div class="col-lg-3 col-sm-6 footer-contact-list mt-lg-0 mt-sm-5 mt-4 pt-sm-0 pt-2">
              <h6 class="footer-title-29">Informations de contact</h6>
              <ul>
...
Nigeria.</li>
  ...
  <div class="container">
        <div class="row bottom-copies">
          <p class="col-lg-8 copy-footer-29">© ${year} AABYFGhana2023. Tous les droits sont réservés. Concu par <a href="https://w3layouts.com/" target="_blank"> Tema Digital Services</a></p>
