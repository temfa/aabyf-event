!(function (s) {
  function t(i, t) {
    ...
    return (
      ...
      null == this.settings.src || this.settings.src.length < 1 ? (console.log("ZoomSlider terminated - invalid input."), void 0) : (this.init(), void 0)
    );
  }
  var e = "zoomSlider",
  ...
  s.extend(t.prototype, {
    ...
    initSingle: function () {
      ...
      e.css({ "background-image": "url('" + this.settings.src[0] + "')" }).appendTo(t),
